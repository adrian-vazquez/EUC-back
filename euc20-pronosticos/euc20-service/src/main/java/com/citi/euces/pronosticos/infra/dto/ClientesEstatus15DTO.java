...
public class ClientesEstatus15DTO implements Serializable {
    ...
    private String fecVencProteccion;
    private String contenido;


    public ClientesEstatus15DTO(Long noCliente, String chequera, String sucursal, String cuenta, Integer idServicio,
                                Integer idOndemand, Integer mes, Integer anio, Integer pIva,
                                Double mComision, Double mIva, Double mTotal, Double mComParcial,
                                Double mIvaParcial, Integer idEstatusComision, Integer idCausaRechazo, String fMovimiento,
                                String fRegistroContable, String llave, Integer catalogadaGc, String csi,
                                String comEc, String comP, String chequeraCargo, Integer noProteccion,
                                String llaveTemporal, Integer estatusProteccion, String contrato, String fIngreso,
                                Integer udemer, String fraqnuiciaRegistro, Integer idFranquicia, String fecVencProteccion, String contenido
    ) {
    ...
    public String getFecVencProteccion() {
        return fecVencProteccion;
    }

    public void setFecVencProteccion(String fecVencProteccion) {
        this.fecVencProteccion = fecVencProteccion;
    }
