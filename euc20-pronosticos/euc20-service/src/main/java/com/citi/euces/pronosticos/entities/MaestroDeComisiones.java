...
@Entity
@Table(name = "PPC_MIS_MAESTRO_COMISIONES")
public class MaestroDeComisiones implements Serializable {
    ...
    public String toString() {
        return "MaestroDeComisiones{" +
                ...
                ", mComision=" + mComision +
                ", mIva=" + mIva +
                ", mComParcial=" + mComParcial +
                ", mIvaParcial=" + mIvaParcial +
                ", idCausaRechazo=" + idCausaRechazo +
                ", fechaMovimiento=" + fechaMovimiento +
                ", fechaRegistroContable='" + fechaRegistroContable + '\'' +
                ", csi=" + csi +
                ", comEc=" + comEc +
                ", comP=" + comP +
                ", chequeraCargo='" + chequeraCargo + '\'' +
                ", noProteccion='" + noProteccion + '\'' +
                ", estatusProteccion=" + estatusProteccion +
                ", contrato='" + contrato + '\'' +
                ", fechaIngreso=" + fechaIngreso +
                ", udmer=" + udmer +
                ", franquiciaRegistro='" + franquiciaRegistro + '\'' +
                ", idFranquicia=" + idFranquicia +
                ", fechaVencProteccion=" + fechaVencProteccion +
                ", openItem='" + openItem + '\'' +
                '}';
    }
}
